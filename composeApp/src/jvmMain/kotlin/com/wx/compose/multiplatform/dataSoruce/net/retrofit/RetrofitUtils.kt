...
class RetrofitUtils private constructor(private val baseUrl: String) {
    ...
    companion object {
        ...
        fun newInstance(baseUrl: String): RetrofitUtils {
            return RetrofitUtils(baseUrl)
        }
    }
...
//                .addInterceptor(RetrofitClient.BaseUrlInterceptor())
                ...
                //设置写信息超时
                .writeTimeout(timeout, TimeUnit.MILLISECONDS).retryOnConnectionFailure(true)//设置出现错误进行重新连接。
                .build();
